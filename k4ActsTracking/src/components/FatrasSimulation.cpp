...
StatusCode FatrasSimulation::execute() {
  ...
  using NeutralSimulation   = ActsFatras::SingleParticleSimulation<NeutralPropagator, NeutralInteractions,
   ...
   ChargedStepper    chargedStepper(std::make_shared<Acts::ConstantBField>(Acts::Vector3{0, 0, 2 * Acts::UnitConstants::T}));
   ...
   Generator generator;
     ...
     std::vector<ActsFatras::Hit> hits;
        ...
        auto result = simulator.simulate(geoCtx, magCtx, generator, *inputParticles,
